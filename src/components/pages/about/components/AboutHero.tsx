        ...
        <section ref={containerRef} className="relative h-screen w-full bg-background overflow-hidden flex flex-col justify-center px-4 md:px-12 pt-20">
            ...
            >
                ...
                <div className="flex flex-col">
                    {["Redefining", "Global Trade"].map((text, i) => (
                        <div key={i} className="">
                            <motion.h1
                            ...
                            >
                                <span className={i === 1 ? "text-transparent bg-clip-text bg-linear-to-r from-emerald-600 to-teal-500 pr-4" : ""}>
                                    {text}
                                </span>
                            </motion.h1>
                        </div>
                ...
                <div className="mt-12 md:mt-24 flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-0 border-t border-border pt-8">
                    ...
                    >
                        Bridging the gap between ambition and execution. We provide the infrastructure and expertise for sustainable global trade success.
                    </motion.p>
